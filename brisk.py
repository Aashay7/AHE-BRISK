...
import numpy as np
try:
    from haar import algo1
    import cv2
except ImportError:
    print 'Couldn\'t find opencv or haar so trying to use the fallback' \
...
def algo2(inp1,inp2):
	...
	# Object Features
	# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
	obj_original = cv2.imread(path.join('Dataset', inp1),  #input1 variable
	...
	obj_mask = cv2.imread(path.join('masks', mask_name),cv2.CV_LOAD_IMAGE_GRAYSCALE)#inp1 mask creation
	if obj_mask is None:
	...
	# Scene Features
	# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
	scene_original = cv2.imread(path.join('Dataset', inp2),cv2.CV_LOAD_IMAGE_COLOR)#inp2 reading
	...
	scene_mask = cv2.imread(path.join('masks', mask_name2),cv2.CV_LOAD_IMAGE_GRAYSCALE)
